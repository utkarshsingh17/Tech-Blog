...
import com.tech.blog.dto.Message;
import com.tech.blog.dto.User;
import com.tech.blog.service.IUserService;
import com.tech.blog.serviceFactory.UserServiceFactory;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(u == null)
            {
                ...
                Message m = new Message("Invalid Username or Password", "error", "alert-danger");
